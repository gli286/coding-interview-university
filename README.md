...
- ### Queue
    ...
    - [x] Implement using linked-list, with tail pointer:
        ...
        - empty()
    - [x] Implement using fixed-sized array: NOT BOTHERING AS I UNDERSTAND AND LINKEDLIST IMPLEMENTATION SEEMS BETTER
...
- ### Hash table
    ...
    - [x] Online Courses: Didn't watch any of the courses that weren't free. Did my own research online.
...
- ### Binary search trees: BSTs
    - [x] [Binary Search Tree Review (video)](https://www.youtube.com/watch?v=x6At0nzX92o&index=1&list=PLA5Lqm4uh9Bbq-E0ZnqTIa8LRaL77ica6) WATCH AGAIN
